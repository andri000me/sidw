    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Input Data User Level</h3>
            </div>
            <form action="<?php echo $action; ?>" method="post">

                <table class='table table-bordered>' <tr>
                    <td width='200'>Level Name <?= form_error('nama_level') ?></td>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id_user_level" value="<?php echo $id_user_level; ?>" />
                            ...
                            <a href="<?php echo site_url('userlevel') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i>Back</a></td>
                    </tr>
                </table>
            </form>
        </div>
