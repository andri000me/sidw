...
class User_model extends CI_Model
{
    ...
    function json()
    {
        $this->datatables->select('id_users,full_name,username,email,nama_level,is_aktif');
        ...
        $this->datatables->add_column('action', anchor(site_url('user/update/$1'), '<i class="fas fa-edit" aria-hidden="true"></i>', array('class' => 'btn btn-primary btn-sm')) . " 
                " . anchor(site_url('user/delete/$1'), '<i class="fas fa-plus" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
