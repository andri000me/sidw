...
class User_level_model extends CI_Model
{
    ...
    function json()
    {
        ...
        $this->datatables->add_column('action', anchor(site_url('userlevel/akses/$1'), '<i class="fas fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-primary btn-sm')) . " 
            " . anchor(site_url('userlevel/update/$1'), '<i class="fas fa-edit" aria-hidden="true"></i>', array('class' => 'btn btn-info btn-sm')) . " 
                " . anchor(site_url('userlevel/delete/$1'), '<i class="fas fa-trash-alt" aria-hidden="true"></i>', 'class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_user_level');
